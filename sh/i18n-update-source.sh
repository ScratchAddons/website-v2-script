...
tx config mapping-bulk --project scratch-addons-website --source-language en --type HTML --file-extension .html --source-file-dir en/html-content --expression \<lang\>/html-content/{filepath}/{filename}{extension} --minimum-perc=0 --execute
